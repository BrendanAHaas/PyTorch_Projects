#Snake game file modified to only be played by the AI for training
import pygame
import random
...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        #Step 1:  Collect user input (not really needed here since AI is controlling snake)
    ...
    def _move(self, action):
        #Map:  [straight, right, left]

        clock_wise = [Direction.RIGHT, Direction.DOWN, Direction.LEFT, Direction.UP]
        idx = clock_wise.index(self.direction)

        #Define snake movement with AI input
